...
with_node \
  ...
  --target "/Users/kenokaren/Documents/dev/damaris/mobile/damaris/ios/Pods/Target Support Files/Pods-Damaris/ExpoModulesProvider.swift" \
  --entitlement "/Users/kenokaren/Documents/dev/damaris/mobile/damaris/ios/Damaris/Damaris.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-document-picker" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-location" "expo-notifications" "expo-system-ui" "expo-web-browser"
