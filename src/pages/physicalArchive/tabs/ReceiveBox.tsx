...
const ReceiveBox = (props: ReceiveBoxProps) => {
    ...
    if (isConnected) {
      ...
      try {
        ...
        if(response?.data?.code == RESPONSE_CODE_SUCCESS){
          setCode('');
          toast('success', 'top', 'SUCCESS!', t('fragment_receive_box_success'));
          ...
          toast('error', 'top', 'ERROR!', t('fragment_receive_box_error_1'));
        } else {
          toast('error', 'top', 'ERROR!', t('fragment_receive_box_error_2'));
        }
        setLoading(false);
      } catch (e) {
          console.log(e);
      ...
      const existingData = await AsyncStorage.getItem('offlineActions_receiveBox_'+userInfo.uniqueKey);
      ...
      await setOfflineDataIntoStorage('offlineActions_receiveBox_'+userInfo.uniqueKey, JSON.stringify(offlineActions));
      toast('info', 'top', 'SUCCESS!', t('fragment_receive_box_success'));
    }
  };
