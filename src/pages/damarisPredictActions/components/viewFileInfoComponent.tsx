...
import { ARCHIVE_TYPE_BOTH, ARCHIVE_TYPE_ELECTRONIC, ARCHIVE_TYPE_PHYSICAL, MOBILE_API_PATH_REST_PREDICT_VIEW_FILE_INFO } from '../../../utils/AppConstants';
...
interface ViewFileInfoComponentProps {
  navigation: any;
...
const ViewFileInfoComponent = (props: ViewFileInfoComponentProps) => {
    ...
    const initData = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.post(url + MOBILE_API_PATH_REST_PREDICT_VIEW_FILE_INFO, data);
  ...
  export default ViewFileInfoComponent;
