...
import { ARCHIVE_TYPE_BOTH, ARCHIVE_TYPE_ELECTRONIC, ARCHIVE_TYPE_PHYSICAL, MOBILE_API_PATH_REST_GET_ADDRESS_CONTENT, MOBILE_API_PATH_REST_PREDICT_VIEW_FILE_INFO } from '../../../utils/AppConstants';
...
interface ShowAddressContentComponentProps {
  navigation: any;
...
const ShowAddressContentComponent = (props: ShowAddressContentComponentProps) => {
    ...
    const initData = async () => {
        ...
        try {
            ...
            const data = {
                ...
                lang: lang,
                storageAddressID: props.storAddrID,
                pagination: {
                    pageNumber: 1,
                    pageSize: 100,
                },
            ...
            const response = await axiosInstance.post(url + MOBILE_API_PATH_REST_GET_ADDRESS_CONTENT, data);
  ...
  export default ShowAddressContentComponent;
